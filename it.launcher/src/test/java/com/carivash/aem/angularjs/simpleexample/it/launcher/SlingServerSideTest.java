 ...
 */
package com.carivash.aem.angularjs.simpleexample.it.launcher;
...
implements SlingRemoteTestParameters, SlingTestsCountChecker {
    ...
    public static final String TEST_SELECTOR = "com.carivash.aem.angularjs.simpleexample.it.tests";
